...
public class DirectoryTest {
    ...
    static Link x = new Link(null, "x", 0, testDate1, null);
    static Link y = new Link(null, "y", 0, testDate2, null);
    ...
    public void verifyDirectoryEqualityHome() {
        String[] expected = { "false", "Home", "0", testDate1.toString(), "Root", "true", "18", "4"};
        Directory dir = home;
        String[] actual = dirToStringArray(dir);
        assertArrayEquals(actual, expected);
    }
    ...
    public void verifyDirectoryEqualityCode() {
        String[] expected = { "false", "Code", "0", testDate2.toString(), "Home", "true", "11", "3"};
        Directory dir = code;
        String[] actual = dirToStringArray(dir);
        assertArrayEquals(actual, expected);
    }
