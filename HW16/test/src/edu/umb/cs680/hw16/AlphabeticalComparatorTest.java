...
public class AlphabeticalComparatorTest {
    ...
    public void GetChildrenTest() {
        ...
        LinkedList<ApfsElement> actualList = dir.getChildren((ApfsElement fse1, 
                                                                ApfsElement fse2)->{return fse1.getName().compareTo(fse2.getName());});
    ...
    public void getSubDirectoriesTest() {
        ...
        LinkedList<ApfsDirectory> actualList = dir.getSubDirectories((ApfsElement fse1, 
                                                                        ApfsElement fse2)->{return fse1.getName().compareTo(fse2.getName());});
    ...
    public void getFilesTest() {
        ApfsDirectory dir = home;
        LinkedList<ApfsFile> actualList = dir.getFiles((ApfsElement fse1, 
                                                            ApfsElement fse2)->{return fse1.getName().compareTo(fse2.getName());});
